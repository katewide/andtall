...
- Если информации недостаточно, возьми значение поля "responsibleId" из контекста задачи.
- В этом случае выведи responsibleId в формате: [USER=<responsibleId>]Исполнитель[/USER]
- Если информации достаточно, возьми значение поля "assignee" из объекта currentTask.
- Возьми только значение ID поля "assignee".
- Выведи значение ID поля "assignee" в формате: [USER=<assignee>]Исполнитель[/USER]
- Не изменяй значения "responsibleId" и "assignee" и не используй другие поля JSON для упоминания исполнителя.
...
1. ...
2. ...
[USER=<assignee>]Исполнитель[/USER]
