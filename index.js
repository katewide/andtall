...
⚠️ [b]Недостаточно информации.[/b] [USER=<assignee>]Исполнитель[/USER], пожалуйста, напиши пояснения.
...
- Выведи значение ID поля "assignee". в формате:[USER=<assignee>]Исполнитель[/USER]
