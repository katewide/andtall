...
- Перед формированием результата критически оцени, достаточно ли информации в полях description, title и comments для понимания сути проблемы и выполненных работ.
- Если содержательные текстовые поля (описание задачи, суть комментариев) практически пустые, содержат только приветствия, обрывки фраз или бессмысленные наборы символов, не пытайся делать предположения и не придумывай содержание.
- Также считай информацию недостаточной, если суммарная длина текста в описании задачи (description) и во всех комментариях (comments) составляет менее 10-15 слов.
